...
pw2.addEventListener("keyup", lowercasepassword);

function lowercasepassword() {
  const pw1value = pw1.value;
  const pw2value = pw2.value;

  if (pw1value === pw2value && pw1value.match(/[a-z]+/)) {
...
pw2.addEventListener("keyup", uppercasepassword);
...
pw2.addEventListener("keyup", numberpassword);

function numberpassword() {
  const pw1value = pw1.value;
  const pw2value = pw2.value;

  if (pw1value === pw2value && pw1value.match(/[0-9]+/)) {
...
pw2.addEventListener("keyup", characterpassword);

function characterpassword() {
  const pw1value = pw1.value;
  const pw2value = pw2.value;

  if (pw1value === pw2value && pw1value.length >= 10) {
